...
export class RegistrationComponent {
  ...
  countries = [
    ...
    { name: 'Cocos Islands', abbreviation: 'CC' },
    ...
    { name: 'East Timor', abbreviation: 'TL' },
    ...
    { name: 'Ivory Coast', abbreviation: 'CI' },
    ...
    { name: 'Republic of the Congo', abbreviation: 'CG' },
